...
const ProductManagement: React.FC = () => {
  ...
  const ProductModal: React.FC<{ product?: Product; onClose: () => void; onSave: (data: ProductFormData) => void }> = ({ 
    product, 
    onClose, 
    onSave 
  }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage your products, pricing, and inventory</p>
        </div>
        <button
